...
def paginate_list[T](
    ...
    return PaginationResult(
        items=page_items, total_count=total_count, page=page, per_page=per_page
    )


def get_pagination_info(
    total_count: int, page: int = 1, per_page: int = 10
) -> dict[str, Any]:
...
def get_page_numbers(
    current_page: int, total_pages: int, max_visible: int = 5
) -> list[int]:
