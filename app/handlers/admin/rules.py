...
"""
    ...
    keyboard = [
        ...
        [types.InlineKeyboardButton(text='<tg-emoji emoji-id="5877629862306385808">◀️</tg-emoji> Назад', callback_data='admin_submenu_settings')],
    ]
        ...
        await callback.message.edit_text(
            ...
            reply_markup=types.InlineKeyboardMarkup(
                inline_keyboard=[
                    ...
                    [types.InlineKeyboardButton(text='<tg-emoji emoji-id="5877629862306385808">◀️</tg-emoji> Назад', callback_data='admin_rules')],
                ]
            ),
        )
        await callback.answer()
