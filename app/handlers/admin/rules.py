    ...
    keyboard = [
        [
            types.InlineKeyboardButton(
                text="Редактировать правила", callback_data="admin_edit_rules"
            )
        ],
        [
            types.InlineKeyboardButton(
                text="Просмотр правил", callback_data="admin_view_rules"
            )
        ],
        [
            types.InlineKeyboardButton(
                text="Очистить правила", callback_data="admin_clear_rules"
            )
        ],
        [
            types.InlineKeyboardButton(
        ...
        [
            types.InlineKeyboardButton(
                text="Помощь по HTML", callback_data="admin_rules_help"
            )
        ],
        [
            types.InlineKeyboardButton(
...
@admin_required
@error_handler
async def cycle_rules_display_mode(
    callback: types.CallbackQuery, db_user: User, db: AsyncSession
):
    new_mode = await cycle_display_mode_setting(
        callback, db, "SERVICE_RULES_DISPLAY_MODE"
    )
    if new_mode is None:
        return
        ...
        await callback.message.edit_text(
            ...
            reply_markup=types.InlineKeyboardMarkup(
                inline_keyboard=[
                    [
                        types.InlineKeyboardButton(
                            text="Редактировать", callback_data="admin_edit_rules"
                        )
                    ],
                    [
                        types.InlineKeyboardButton(
                            text="Очистить", callback_data="admin_clear_rules"
                        )
                    ],
                    [
                        types.InlineKeyboardButton(
                            text="Назад", callback_data="admin_rules"
                        )
                    ],
                ]
            ),
...
async def start_edit_rules(
    ...
    try:
        ...
        await callback.message.edit_text(
            ...
            reply_markup=types.InlineKeyboardMarkup(
                inline_keyboard=[
                    [
                        types.InlineKeyboardButton(
                            text="HTML помощь", callback_data="admin_rules_help"
                        )
                    ],
                    [
                        types.InlineKeyboardButton(
                            text="Отмена", callback_data="admin_rules"
                        )
                    ],
                ]
            ),
        ...
        await callback.answer(
            "Ошибка при загрузке правил для редактирования", show_alert=True
        )
...
async def process_rules_edit(
    ...
    try:
        ...
        preview_text += (
            "<b>Внимание!</b> Новые правила будут показываться всем пользователям.\n\n"
        )
        ...
        await message.answer(
            ...
            reply_markup=types.InlineKeyboardMarkup(
                inline_keyboard=[
                    [
                        types.InlineKeyboardButton(
                            text="Сохранить", callback_data="admin_save_rules"
                        ),
                        types.InlineKeyboardButton(
                            text="Отмена", callback_data="admin_rules"
                        ),
...
async def save_rules(
        ...
        await callback.message.edit_text(
            ...
            reply_markup=types.InlineKeyboardMarkup(
                inline_keyboard=[
                    [
                        types.InlineKeyboardButton(
                            text="Попробовать снова", callback_data="admin_edit_rules"
                        )
                    ],
                    [
                        types.InlineKeyboardButton(
                            text="К правилам", callback_data="admin_rules"
                        )
                    ],
                ]
            ),
    ...
    try:
        await create_or_update_rules(
            db=db, content=new_rules, language=db_user.language
        )
        ...
        await callback.message.edit_text(
            ...
            reply_markup=types.InlineKeyboardMarkup(
                inline_keyboard=[
                    [
                        types.InlineKeyboardButton(
                            text="Просмотреть", callback_data="admin_view_rules"
                        )
                    ],
                    [
                        types.InlineKeyboardButton(
        ...
        await state.clear()
        logger.info(
            "Правила сервиса обновлены администратором", telegram_id=db_user.telegram_id
        )
        await callback.answer()
        ...
        await callback.message.edit_text(
            ...
            reply_markup=types.InlineKeyboardMarkup(
                inline_keyboard=[
                    [
                        types.InlineKeyboardButton(
                            text="Попробовать снова", callback_data="admin_save_rules"
                        )
                    ],
                    [
                        types.InlineKeyboardButton(
    ...
    await callback.message.edit_text(
        ...
        reply_markup=types.InlineKeyboardMarkup(
            inline_keyboard=[
                [
                    types.InlineKeyboardButton(
                        text="Да, очистить", callback_data="admin_confirm_clear_rules"
                    ),
                    types.InlineKeyboardButton(
                        text="Отмена", callback_data="admin_rules"
                    ),
        ...
        await callback.message.edit_text(
            ...
            reply_markup=types.InlineKeyboardMarkup(
                inline_keyboard=[
                    [
                        types.InlineKeyboardButton(
                            text="Создать новые", callback_data="admin_edit_rules"
                        )
                    ],
                    [
                        types.InlineKeyboardButton(
                            text="Посмотреть текущие", callback_data="admin_view_rules"
                        )
                    ],
                    [
                        types.InlineKeyboardButton(
...
def register_handlers(dp: Dispatcher):
    ...
    dp.callback_query.register(
        cycle_rules_display_mode, F.data == "admin_rules_display_mode"
    )
    ...
    dp.callback_query.register(
        confirm_clear_rules, F.data == "admin_confirm_clear_rules"
    )
