    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                ...
                make_button(
                    text=texts.ADMIN_REFERRALS, callback_data="admin_referrals"
                ),
            ],
            [
                make_button(
                    text=texts.ADMIN_SUBSCRIPTIONS, callback_data="admin_subscriptions"
                )
            ],
...
def get_admin_promo_submenu_keyboard(language: str = "ru") -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                make_button(
                    text=texts.ADMIN_PROMOCODES, callback_data="admin_promocodes"
                ),
                make_button(
                    text=texts.ADMIN_STATISTICS, callback_data="admin_statistics"
                ),
            ],
...
def get_admin_communications_submenu_keyboard(
    language: str = "ru",
...
def get_admin_settings_submenu_keyboard(language: str = "ru") -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                make_button(
                    text=texts.ADMIN_REMNAWAVE, callback_data="admin_remnawave"
                ),
                make_button(
                    text=texts.ADMIN_MONITORING, callback_data="admin_monitoring"
                ),
            ],
            [
                make_button(
...
def get_admin_report_result_keyboard(language: str = "ru") -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                make_button(
                    text=texts.t("REPORT_CLOSE", "Закрыть"),
                    callback_data="admin_close_report",
                )
            ]
        ]
    )
...
def get_admin_users_keyboard(language: str = "ru") -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            ...
            [
                make_button(
                    text=texts.ADMIN_STATISTICS, callback_data="admin_users_stats"
                ),
                make_button(
                    text=_t(
                        texts,
...
def get_admin_subscriptions_keyboard(language: str = "ru") -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            ...
            [
                make_button(
                    text=texts.ADMIN_STATISTICS, callback_data="admin_subs_stats"
                )
            ],
            [make_button(text=texts.BACK, callback_data="admin_submenu_users")],
        ]
...
def get_daily_contest_manage_keyboard(
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                make_button(
                    text=toggle_text, callback_data=f"admin_daily_toggle_{template_id}"
                ),
                make_button(
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                ...
                make_button(
                    text=_t(
                        texts, "ADMIN_CAMPAIGN_BONUS_SUBSCRIPTION", "Пробная подписка"
                    ),
...
def get_promocode_management_keyboard(
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                make_button(
                    text=_t(texts, "ADMIN_PROMOCODE_EDIT", "Редактировать"),
            ...
            [
                ...
                make_button(
                    text=_t(texts, "ADMIN_PROMOCODE_DELETE", "Удалить"),
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            ...
            [
                make_button(
                    text=_t(
                        texts, "ADMIN_PINNED_MESSAGE_DELETE", "Удалить и отключить"
                    ),
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                make_button(
                    text=_t(
                        texts, "ADMIN_PINNED_BROADCAST_NOW", "Разослать сейчас всем"
                    ),
            ...
            [
                make_button(
                    text=_t(
                        texts, "ADMIN_PINNED_BROADCAST_ON_START", "Только при /start"
                    ),
...
def get_admin_monitoring_keyboard(language: str = "ru") -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                make_button(
                    text=_t(texts, "ADMIN_MONITORING_START", "Запустить"),
                    callback_data="admin_mon_start",
                ),
                make_button(
                    text=_t(texts, "ADMIN_MONITORING_STOP", "Остановить"),
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                make_button(
                    text=_t(
                        texts, "ADMIN_REMNAWAVE_SYSTEM_STATS", "Системная статистика"
                    ),
            ...
            [
                ...
                make_button(
                    text=_t(
                        texts, "ADMIN_REMNAWAVE_MANAGE_SQUADS", "Управление сквадами"
                    ),
...
def get_user_management_keyboard(
    ...
    keyboard = [
        [
            ...
            make_button(
                text=_t(
                    texts, "ADMIN_USER_SUBSCRIPTION_SETTINGS", "Подписка и настройки"
                ),
    ...
    if user_status == "active":
        keyboard.append(
            [
                ...
                make_button(
                    text=_t(texts, "ADMIN_USER_DELETE", "Удалить"),
...
def get_user_restrictions_keyboard(
    ...
    # Кнопка назад
    keyboard.append(
        [make_button(text=texts.BACK, callback_data=f"admin_user_manage_{user_id}")]
    )
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            ...
            [
                make_button(
                    text=_t(
                        texts, "ADMIN_PROMOCODE_TYPE_DISCOUNT", "Одноразовая скидка"
                    ),
    ...
    if total_pages > 1:
        ...
        if page > 1:
            pagination_row.append(
                make_button(text="←", callback_data=f"admin_promo_list_page_{page - 1}")
            )

        pagination_row.append(
            make_button(text=f"{page}/{total_pages}", callback_data="current_page")
        )
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            ...
            [
                make_button(
                    text=_t(
                        texts, "ADMIN_BROADCAST_TARGET_ACTIVE_ZERO", "Активна 0 ГБ"
                    ),
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            ...
            [
                make_button(
                    text=_t(
                        texts, "ADMIN_CRITERIA_INACTIVE_WEEK", "Неактивные 7+ дней"
                    ),
                    callback_data="criteria_inactive_week",
                ),
                make_button(
                    text=_t(
                        texts, "ADMIN_CRITERIA_INACTIVE_MONTH", "Неактивные 30+ дней"
                    ),
            ...
            [
                ...
                make_button(
                    text=_t(
                        texts, "ADMIN_CRITERIA_PROMOCODES", "Использовали промокоды"
                    ),
...
def get_broadcast_history_keyboard(
    page: int, total_pages: int, language: str = "ru"
) -> InlineKeyboardMarkup:
    texts = get_texts(language)
    keyboard = []
    ...
    if total_pages > 1:
        ...
        if page > 1:
            pagination_row.append(
                make_button(
                    text="←", callback_data=f"admin_msg_history_page_{page - 1}"
                )
            )
...
def get_sync_options_keyboard(language: str = "ru") -> InlineKeyboardMarkup:
    ...
    keyboard = [
        ...
        [
            make_button(
                text=_t(texts, "ADMIN_SYNC_TO_PANEL", "Синхронизация в панель"),
...
def get_sync_confirmation_keyboard(
    ...
    keyboard = [
        ...
        [
            make_button(
                text=_t(texts, "ADMIN_CANCEL", "Отмена"), callback_data="admin_rw_sync"
            )
        ],
    ]
...
def get_sync_result_keyboard(
    sync_type: str, has_errors: bool = False, language: str = "ru"
) -> InlineKeyboardMarkup:
    texts = get_texts(language)
    keyboard = []
    ...
    keyboard.extend(
        [
            ...
            [
                make_button(
                    text=_t(texts, "ADMIN_SYNC_BACK", "К синхронизации"),
                    callback_data="admin_rw_sync",
                )
            ],
            [
...
def get_node_management_keyboard(
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                make_button(
                    text=_t(texts, "ADMIN_NODE_ENABLE", "Включить"),
                    callback_data=f"node_enable_{node_uuid}",
                ),
                make_button(
                    text=_t(texts, "ADMIN_NODE_DISABLE", "Отключить"),
...
def get_squad_management_keyboard(
    squad_uuid: str, language: str = "ru"
) -> InlineKeyboardMarkup:
    texts = get_texts(language)
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                make_button(
                    text=_t(
                        texts, "ADMIN_SQUAD_ADD_ALL", "Добавить всех пользователей"
                    ),
            ...
            [
                make_button(
                    text=_t(
                        texts, "ADMIN_SQUAD_REMOVE_ALL", "Удалить всех пользователей"
                    ),
            ...
            [
                make_button(
                    text=_t(texts, "ADMIN_SQUAD_EDIT", "Редактировать"),
                    callback_data=f"squad_edit_{squad_uuid}",
                ),
                make_button(
                    text=_t(texts, "ADMIN_SQUAD_DELETE", "Удалить сквад"),
...
def get_squad_edit_keyboard(
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            ...
            [
                make_button(
                    text=_t(texts, "ADMIN_SQUAD_RENAME", "Переименовать"),
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                ...
                make_button(
                    text=_t(texts, "ADMIN_MONITORING_STOP_HARD", "Остановить"),
                    callback_data="admin_mon_stop",
                ),
            ],
            [
                ...
                make_button(
                    text=_t(
                        texts, "ADMIN_MONITORING_TRAFFIC_CHECK", "Проверка трафика"
                    ),
            ...
            [
                make_button(
                    text=_t(
                        texts, "ADMIN_MONITORING_TEST_NOTIFICATIONS", "Тест уведомлений"
                    ),
                    callback_data="admin_mon_test_notifications",
                ),
                make_button(
                    text="Настройки трафика", callback_data="admin_mon_traffic_settings"
                ),
            ],
            [
                make_button(
                    text=_t(texts, "ADMIN_BACK_TO_ADMIN", "Назад в админку"),
...
def get_monitoring_logs_navigation_keyboard(
    ...
    if total_pages > 1:
        ...
        if current_page > 1:
            nav_row.append(
                make_button(
                    text="←", callback_data=f"admin_mon_logs_page_{current_page - 1}"
                )
            )

        nav_row.append(
            make_button(
                text=f"{current_page}/{total_pages}", callback_data="current_page_info"
            )
        )
    ...
    if has_logs:
        management_row.extend(
            [
                refresh_button,
                make_button(
                    text=_t(texts, "ADMIN_MONITORING_CLEAR", "Очистить"),
                    callback_data="admin_mon_clear_logs",
                ),
            ]
        )
    ...
    keyboard.append(
        [
            make_button(
                text=_t(texts, "ADMIN_BACK_TO_MONITORING", "Назад к мониторингу"),
...
def get_log_detail_keyboard(
    log_id: int, current_page: int = 1, language: str = "ru"
) -> InlineKeyboardMarkup:
    texts = get_texts(language)
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                ...
                make_button(
                    text=_t(texts, "ADMIN_CANCEL", "Отмена"),
                    callback_data="admin_mon_logs",
                ),
            ],
            [
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                make_button(
                    text=_t(
                        texts, "ADMIN_MONITORING_SET_INTERVAL", "Интервал проверки"
                    ),
            ...
            [
                make_button(
                    text=_t(
                        texts,
                        "ADMIN_MONITORING_AUTOPAY_SETTINGS",
                        "Настройки автооплаты",
                    ),
                    callback_data="admin_mon_autopay_settings",
                ),
                make_button(
                    text=_t(
                        texts, "ADMIN_MONITORING_AUTO_CLEANUP", "Автоочистка логов"
                    ),
            ...
            [
                make_button(
                    text=_t(texts, "ADMIN_BACK_TO_MONITORING", "К мониторингу"),
                    callback_data="admin_monitoring",
                )
            ],
        ]
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            ...
            [
                make_button(
                    text=_t(
                        texts, "ADMIN_MONITORING_FILTER_CYCLES", "Циклы мониторинга"
                    ),
...
def get_server_edit_keyboard(
    server_id: int, is_available: bool, language: str = "ru"
) -> InlineKeyboardMarkup:
    texts = get_texts(language)
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            ...
            [
                make_button(
                    text=toggle_text, callback_data=f"admin_server_toggle_{server_id}"
                )
            ],
            [
                make_button(
...
def get_admin_pagination_keyboard(
    ...
    if total_pages > 1:
        ...
        if current_page > 1:
            row.append(
                make_button(
                    text="←", callback_data=f"{callback_prefix}_page_{current_page - 1}"
                )
            )
        ...
        keyboard.append(
            [
                make_button(
                    text=_t(
                        texts,
                        "ADMIN_MAINTENANCE_START_MONITORING",
...
def get_welcome_text_keyboard(
    language: str = "ru", is_enabled: bool = True
) -> InlineKeyboardMarkup:
    texts = get_texts(language)
    toggle_text = (
    ...
    keyboard = [
        ...
        [
            ...
            make_button(
                text=_t(texts, "ADMIN_WELCOME_SHOW", "Показать текущий"),
                callback_data="show_welcome_text",
            ),
        ],
        [
            make_button(
                text=_t(texts, "ADMIN_WELCOME_PREVIEW", "Предпросмотр"),
        ...
        [
            make_button(
                text=_t(texts, "ADMIN_WELCOME_HTML", "HTML форматирование"),
...
def get_broadcast_button_labels(language: str) -> dict[str, str]:
    return {
        key: value["text"]
        for key, value in get_broadcast_button_config(language).items()
    }
...
def get_message_buttons_selector_keyboard(language: str = "ru") -> InlineKeyboardMarkup:
    return get_updated_message_buttons_selector_keyboard_with_media(
        list(DEFAULT_BROADCAST_BUTTONS), False, language
    )
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            ...
            [
                ...
                make_button(
                    text=_t(texts, "ADMIN_BROADCAST_SKIP_MEDIA", "Пропустить медиа"),
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                make_button(
                    text=_t(
                        texts, "ADMIN_BROADCAST_USE_MEDIA", "Использовать это медиа"
                    ),
            ...
            [
                make_button(
                    text=_t(texts, "ADMIN_BROADCAST_NO_MEDIA", "Без медиа"),
                    callback_data="skip_media",
                ),
                make_button(
                    text=_t(texts, "ADMIN_CANCEL", "Отмена"),
...
def get_updated_message_buttons_selector_keyboard_with_media(
    ...
    for row in BROADCAST_BUTTON_ROWS:
        ...
        for button_key in row:
            ...
            row_buttons.append(
                make_button(text=toggle_text, callback_data=f"btn_{button_key}")
            )
        if row_buttons:
    ...
    if has_media:
        keyboard.append(
            [
                make_button(
                    text=_t(texts, "ADMIN_BROADCAST_CHANGE_MEDIA", "Изменить медиа"),
