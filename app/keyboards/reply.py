...
def get_main_reply_keyboard(language: str = "ru") -> ReplyKeyboardMarkup:
    ...
    keyboard.append(
        [KeyboardButton(text=texts.MENU_SUPPORT), KeyboardButton(text=texts.MENU_RULES)]
    )
...
def get_cancel_keyboard(language: str = "ru") -> ReplyKeyboardMarkup:
    ...
    return ReplyKeyboardMarkup(
        keyboard=[[KeyboardButton(text=texts.CANCEL)]],
        resize_keyboard=True,
...
def get_skip_keyboard(language: str = "ru") -> ReplyKeyboardMarkup:
    texts = get_texts(language)
    return ReplyKeyboardMarkup(
        keyboard=[[KeyboardButton(text=texts.REFERRAL_CODE_SKIP)]],
        resize_keyboard=True,
        one_time_keyboard=True,
    )
...
def get_contact_keyboard(language: str = "ru") -> ReplyKeyboardMarkup:
    ...
    return ReplyKeyboardMarkup(
        keyboard=[
            [
                KeyboardButton(
                    text=texts.t("SEND_CONTACT_BUTTON", "Отправить контакт"),
...
def get_location_keyboard(language: str = "ru") -> ReplyKeyboardMarkup:
    ...
    return ReplyKeyboardMarkup(
        keyboard=[
            [
                KeyboardButton(
                    text=texts.t("SEND_LOCATION_BUTTON", "Отправить геолокацию"),
