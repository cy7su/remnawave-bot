...
async def get_pal24_payment_by_id(
...
async def get_pal24_payment_by_id_for_update(
    db: AsyncSession, payment_id: int
) -> Pal24Payment | None:
...
async def get_pal24_payment_by_bill_id(
...
async def get_pal24_payment_by_order_id(
