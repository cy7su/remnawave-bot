...
class CryptoBotService:
    ...
    def verify_webhook_signature(self, body: str, signature: str) -> bool:
        ...
        try:
            ...
            expected = hmac.new(
                secret_hash, body.encode("utf-8"), hashlib.sha256
            ).hexdigest()
            ...
            expected_reserialized = hmac.new(
                secret_hash, check_string.encode("utf-8"), hashlib.sha256
            ).hexdigest()
            ...
            check_string_ascii = json.dumps(
                parsed, separators=(",", ":"), ensure_ascii=True
            )
            expected_ascii = hmac.new(
                secret_hash, check_string_ascii.encode("utf-8"), hashlib.sha256
            ).hexdigest()
