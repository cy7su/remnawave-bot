    ...
    def verify_webhook_signature(self, payload: str, signature: str) -> bool:
        ...
        try:
            expected_signature = hmac.new(
                self.api_key.encode(), payload.encode(), hashlib.sha256
            ).hexdigest()
    ...
    async def process_webhook(self, payload_or_data) -> dict[str, Any] | None:
        try:
            ...
            try:
                ...
                logger.error(
                    "Некорректный telegram_user_id", telegram_user_id=telegram_user_id
                )
                return None
            ...
            result = {
                "event_type": "payment",
                "payment_id": payment_id
                or f"tribute_{telegram_user_id}_{amount_kopeks}",
