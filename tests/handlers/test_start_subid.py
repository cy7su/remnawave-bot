...
class TestSplitStartParamSubid:
    def test_returns_campaign_and_subid_for_canonical_format(self) -> None:
        assert _split_start_param_subid(
            "clkcl_subid_519c82ce-1322-410b-8c7a-9992085a38f0"
        ) == (
            "clkcl",
    ...
    def test_parametrized_valid_inputs(
        self, param: str, expected: tuple[str, str]
    ) -> None:
