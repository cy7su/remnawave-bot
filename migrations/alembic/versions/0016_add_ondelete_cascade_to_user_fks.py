...
_FK_CHANGES: list[tuple[str, str, str, str]] = [
    ...
    (
        ...
        "user_id",
        "CASCADE",
        "cloudpayments_payments_user_id_fkey",
    ),
    ...
    (
        ...
        "user_id",
        "CASCADE",
        "subscription_conversions_user_id_fkey",
    ),
    ...
    (
        ...
        "created_by",
        "SET NULL",
        "advertising_campaigns_created_by_fkey",
    ),
    (
        "advertising_campaigns",
        "partner_user_id",
        "SET NULL",
        "advertising_campaigns_partner_user_id_fkey",
    ),
    ...
    (
        ...
        "processed_by",
        "SET NULL",
        "partner_applications_processed_by_fkey",
    ),
    (
        "referral_contest_events",
        "referrer_id",
        "CASCADE",
        "referral_contest_events_referrer_id_fkey",
    ),
    (
        "referral_contest_events",
        "referral_id",
        "CASCADE",
        "referral_contest_events_referral_id_fkey",
    ),
    ...
    (
        ...
        "user_id",
        "CASCADE",
        "advertising_campaign_registrations_user_id_fkey",
    ),
    ...
    (
        ...
        "user_id",
        "CASCADE",
        "cabinet_refresh_tokens_user_id_fkey",
    ),
    ...
    (
        ...
        "created_by",
        "SET NULL",
        "promo_offer_templates_created_by_fkey",
    ),
    ...
    (
        ...
        "actor_user_id",
        "SET NULL",
        "support_audit_logs_actor_user_id_fkey",
    ),
    (
        "support_audit_logs",
        "target_user_id",
        "SET NULL",
        "support_audit_logs_target_user_id_fkey",
    ),
    ...
    (
        ...
        "created_by",
        "SET NULL",
        "referral_contests_created_by_fkey",
    ),
]
...
def upgrade() -> None:
    ...
    for table, column, nullable in _ALL_USER_FKS:
        ...
        if nullable:
            ...
            op.execute(
                f"DELETE FROM {table} " f"WHERE {column} NOT IN (SELECT id FROM users)"
            )
    ...
    for table, column, ondelete, fk_name in _FK_CHANGES:
        ...
        op.create_foreign_key(
            fk_name, table, "users", [column], ["id"], ondelete=ondelete
        )
