...
def upgrade() -> None:
    ...
    op.add_column(
        "landing_pages", sa.Column("discount_percent", sa.Integer(), nullable=True)
    )
    op.add_column(
        "landing_pages", sa.Column("discount_overrides", sa.JSON(), nullable=True)
    )
    op.add_column(
        "landing_pages",
    ...
    op.add_column(
        "landing_pages", sa.Column("discount_badge_text", sa.JSON(), nullable=True)
    )
